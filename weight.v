...
Module Info.
  ...
  Definition source_file := "weight.c".
...
Definition _filter_step : ident := $"filter_step".
...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 37) :: Init_int8 (Int.repr 56) ::
                Init_int8 (Int.repr 46) :: Init_int8 (Int.repr 51) ::
                Init_int8 (Int.repr 108) :: Init_int8 (Int.repr 102) ::
                Init_int8 (Int.repr 10) :: Init_int8 (Int.repr 0) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.

Definition f_filter_step := {|
  fn_return := tdouble;
  fn_callconv := cc_default;
  fn_params := ((_i, tint) :: (_g, tdouble) :: (_m, tdouble) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Sreturn (Some (Ebinop Oadd (Etempvar _g tdouble)
                 (Ebinop Omul
                   (Ebinop Odiv
                     (Econst_float (Float.of_bits (Int64.repr 4607182418800017408)) tdouble)
                     (Ecast (Etempvar _i tint) tdouble) tdouble)
                   (Ebinop Osub (Etempvar _m tdouble) (Etempvar _g tdouble)
...
Definition f_main := {|
  ...
  fn_callconv := cc_default;
  fn_params := nil;
  fn_vars := ((_input, tdouble) :: nil);
  fn_temps := ((_curr, tdouble) :: (_i, tint) :: (_t'2, tdouble) ::
               (_t'1, tint) :: (_t'3, tdouble) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _curr (Ecast (Econst_int (Int.repr 1000) tint) tdouble))
    (Ssequence
          ...
          (Ssequence
            (Ssequence
              (Scall (Some _t'1)
                ...
                ((Evar ___stringlit_1 (tarray tschar 4)) ::
                 (Eaddrof (Evar _input tdouble) (tptr tdouble)) :: nil))
            ...
            (Ssequence
              ...
              (Ssequence
                (Ssequence
                  (Ssequence
                    (Sset _t'3 (Evar _input tdouble))
                    (Scall (Some _t'2)
                      (Evar _filter_step (Tfunction
                                           (Tcons tint
                                             (Tcons tdouble
                                               (Tcons tdouble Tnil))) tdouble
                                           cc_default))
                      ((Etempvar _i tint) :: (Etempvar _curr tdouble) ::
                       (Etempvar _t'3 tdouble) :: nil)))
                  (Sset _curr (Etempvar _t'2 tdouble)))
                (Scall None
                  (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil) tint
                                  {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                  ((Evar ___stringlit_2 (tarray tschar 8)) ::
                   (Etempvar _curr tdouble) :: nil)))))
          Sskip)
...
((___stringlit_1, Gvar v___stringlit_1) ::
 ...
 (___isoc99_scanf,
   Gfun(External (EF_external "__isoc99_scanf"
     ...
     (Tcons (tptr tschar) Tnil) tint
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_filter_step, Gfun(Internal f_filter_step)) ::
 (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _filter_step :: ___isoc99_scanf :: _printf :: ___builtin_debug ::
